...
<ins>**Text / String**</ins>
A sequence of one or more characters/grapheme clusters.
> I couldn't find any real difference between the two (or usage isn't consistent between languages that use them). I think it would be better to stick with "String" here as it's a term C is more familiar with unlike "Text".
...
All Code points can be found at https://www.unicode.org/Public/15.0.0/ucd/UnicodeData.txt.
I may need to parse that at one point, I will see.
